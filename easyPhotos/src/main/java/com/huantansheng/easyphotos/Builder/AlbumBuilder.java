...
public class AlbumBuilder {
     ...
     * @return @return AlbumBuilder
     */
    public AlbumBuilder setVideoRecordLimitTime(int second) {
        Setting.videoRecordLimitTime = second;
        return AlbumBuilder.this;
    }
     ...
     * @return @return AlbumBuilder
     */
    public AlbumBuilder setCameraFacing(int facing) {
        Setting.cameraFacing = facing;
        return AlbumBuilder.this;
    }
